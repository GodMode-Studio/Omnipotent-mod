...
public final class OptionalMod<T> {
     ...
     */
    private static final OptionalMod<?> EMPTY = new OptionalMod<>(null);
     ...
     */
    public static <T> OptionalMod<T> of(T value) {
        return new OptionalMod<>(Objects.requireNonNull(value));
    }
    ...
    public static <T> OptionalMod<T> ofNullable(T value) {
        return value == null ? (OptionalMod<T>) EMPTY
                : new OptionalMod<>(value);
    }
    ...
    public <U> OptionalMod<U> map(Function<? super T, ? extends U> mapper) {
        ...
        if (isEmpty()) {
            ...
            return OptionalMod.ofNullable(mapper.apply(value));
        }
    }
    ...
    public <U> OptionalMod<U> flatMap(Function<? super T, ? extends OptionalMod<? extends U>> mapper) {
        ...
        if (isEmpty()) {
            ...
            @SuppressWarnings("unchecked")
            OptionalMod<U> r = (OptionalMod<U>) mapper.apply(value);
    ...
    public OptionalMod<T> or(Supplier<? extends OptionalMod<? extends T>> supplier) {
        ...
        if (isPresent()) {
            ...
            @SuppressWarnings("unchecked")
            OptionalMod<T> r = (OptionalMod<T>) supplier.get();
            return Objects.requireNonNull(r);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof OptionalMod<?> other
