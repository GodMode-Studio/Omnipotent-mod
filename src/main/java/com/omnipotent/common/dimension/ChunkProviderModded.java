...
public class ChunkProviderModded implements IChunkGenerator {
    private static final IBlockState STONE = Blocks.BEDROCK.getDefaultState();
    private static final IBlockState STONE2 = Blocks.BEDROCK.getDefaultState();
    private static final IBlockState FLUID = STONE;
