package com.omnipotent.common.specialgui.net;
...
public class KaiaSlotChangePacket implements IMessage {

    private int windowId;
    private int slotIndex;
    private ItemStack stack;

    public KaiaSlotChangePacket() {
    }

    public KaiaSlotChangePacket(int windowId, int slotIndex, ItemStack stack) {
    ...
    public static class MessageHandler implements IMessageHandler<KaiaSlotChangePacket, IMessage> {

        @Override
        @SideOnly(Side.CLIENT)
        public IMessage onMessage(KaiaSlotChangePacket message, MessageContext ctx) {
