...
public class RenderCustomLightningBolt extends RenderLightningBolt {
    public RenderCustomLightningBolt(RenderManager renderManagerIn) {
        super(renderManagerIn);
    }

    @Override
    public void doRender(EntityLightningBolt entity, double x, double y, double z, float entityYaw, float g) {
            ...
            for (int j = 0; j < 3; ++j) {
                ...
                for (int i1 = k; i1 >= l; --i1) {
                    ...
                    for (int j1 = 0; j1 < 5; ++j1) {
                        ...
                        bufferbuilder.pos(d10 + d2, y + (double) (i1 * 16), d11 + d3).color(rand.nextInt(255), rand.nextInt(255), rand.nextInt(255), rand.nextInt(255)).endVertex();
                        bufferbuilder.pos(d8 + d4, y + (double) ((i1 + 1) * 16), d9 + d5).color(0, 0, 0, 0).endVertex();
                    }
    ...
    protected ResourceLocation getEntityTexture(EntityLightningBolt entity) {
        return new ResourceLocation("customlightningbolt");
    }
}
